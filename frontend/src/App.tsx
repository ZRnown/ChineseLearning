            ...
            <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
              <div className="flex items-center justify-between h-16">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  {/* 添加收藏夹链接，仅用户登录时显示 */}
                  {user && (
                    <Link to="/favorites" className="flex items-center px-3 py-2 rounded-md text-sm font-medium text-[#f8f5f0] hover:bg-[#6b3410] transition-colors">
                      <BiHeart className="mr-2" />
                      收藏夹
                    </Link>
                  )}
                  {/* 添加历史记录链接 */}
                  <Link to="/history" className="flex items-center px-3 py-2 rounded-md text-sm font-medium text-[#f8f5f0] hover:bg-[#6b3410] transition-colors">
